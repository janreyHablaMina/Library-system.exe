        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className={`rounded-2xl border p-6 shadow-sm ${cardClass}`}>
            ...
            <div className="flex items-center gap-6 mb-8">
              <div className="h-20 w-20 overflow-hidden rounded-full border-2 border-white shadow-md dark:border-slate-800 shrink-0">
          ...
          <div className={`rounded-2xl border p-6 shadow-sm ${cardClass}`}>
            ...
            <div className="flex gap-6 mb-6">
              <div className="w-24 shrink-0 overflow-hidden rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm aspect-[2/3]">
